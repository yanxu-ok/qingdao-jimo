...
function requestUrl(num) {
  if (str.indexOf("keyword") != -1) {
    // 搜索
    request(_URL + "/app/article/common/json?" + str + '&_orgid_=' + jiGouId + '&page=' + num, 'Get', 'department', 'myHeader_contain');
  }
}
...
$(function () {
  ...
  document.getElementById('search_btn1').onclick = function () {
    // 获取输入框中的值
    var serachValue = document.getElementById('search_value').value;
    var str1 = 'keyword=' + serachValue;
    request(_URL + "/app/article/common/json?" + str1 + '&_orgid_=' + jiGouId + '&page=' + num, 'Get', 'department', 'myHeader_contain');
  }
